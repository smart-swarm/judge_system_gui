...
void JudgeGui::record_to_file(std::string file_path_name, double t_remain){
    ...
    double a_score = 50.0 * a_win +4.0 * (count_alive_a - count_alive_b) + 0.02 * (_home_a_blood_remain -_home_b_blood_remain) + t_remain * a_win / 18.0;
    double b_score = 50.0 * b_win +4.0 * (count_alive_b - count_alive_a) + 0.02 * (_home_b_blood_remain -_home_a_blood_remain) + t_remain * b_win / 18.0;
